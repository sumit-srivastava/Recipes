package com.java.se7.concurrency.recipes.thread.executors.taskExecutionPeriodically;
...
public class Main {
	...
	public static void main(String[] args) {
		...
		// Create a new task and send it to the executor. It will start with a delay of 1 second and then
