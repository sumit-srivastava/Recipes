package com.java.se7.concurrency.recipes.thread.executors.usingCallableProcessingFirstResult;
...
public class Main {
	...
	public static void main(String[] args) {
		...
		try {
			...
			// that finish without throwing any Exception. If all the tasks throw an Exception, the
