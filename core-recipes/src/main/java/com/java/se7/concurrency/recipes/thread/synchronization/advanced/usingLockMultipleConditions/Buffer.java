package com.java.se7.concurrency.recipes.thread.synchronization.advanced.usingLockMultipleConditions;
...
/**
 * This class implements a buffer to store the simulate file lines between the
